...
create table if not exists clients (
  ...
  per_project_rate numeric not null default 0,
  project_type_rates jsonb not null default '[]',
  allowed_project_type_ids text[] not null default '{}',
  default_project_type_id text not null default '',
  role_billing_multipliers jsonb not null default '[]',
  partner_split jsonb,
  created_at timestamptz not null default now()
);
