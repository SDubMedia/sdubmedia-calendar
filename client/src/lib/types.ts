...
export type DashboardWidgetId = "metrics" | "todos" | "missingLocations" | "miniSessions" | "pipeline" | "activity" | "upcoming" | "currentProjects" | "realEstate" | "invoices" | "mileage" | "revenue";
...
export const DEFAULT_DASHBOARD_WIDGETS: DashboardWidgetConfig[] = [
  ...
  // Projects with no location (so no mileage). Renders nothing when there
  // are none, and this switch also governs the same box on the To-Dos page.
  { id: "missingLocations", enabled: true },
...
export const DASHBOARD_WIDGET_LABELS: Record<DashboardWidgetId, string> = {
  ...
  missingLocations: "Missing locations (projects that can't track mileage yet; also shows on To-Dos)",
...
// One client-facing note on a project. A project holds a list of these.
...
export interface Project {
  ...
  notes: string;
  // Client-facing delivery notes (revisions, # of videos delivered, who's in
  // them). Written FOR the client and shown on their report — a running list,
